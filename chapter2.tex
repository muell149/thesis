...
\begin{figure}[htbp] 
  {\centering
    \subfigure{\includegraphics[width=0.4\textwidth]{ch2_figs/ggH.pdf}}
    \subfigure{\includegraphics[width=0.4\textwidth]{ch2_figs/VBFH.pdf}}\\
    \subfigure{\includegraphics[width=0.4\textwidth]{ch2_figs/VH.pdf}}
    \subfigure{\includegraphics[width=0.4\textwidth]{ch2_figs/ttH.pdf}}\\

    %% \subfigure[gluon fusion]{\includegraphics[width=0.3\textwidth]{ch2_figs/ggH.pdf}}
    %% \subfigure[vector boson fusion]{\includegraphics[width=0.3\textwidth]{ch2_figs/VBFH.pdf}}
    %% \subfigure[Higgs-strahlung]{\includegraphics[width=0.3\textwidth]{ch2_figs/VH.pdf}}
    %% \subfigure[associated production]{\includegraphics[width=0.3\textwidth]{ch2_figs/ttH.pdf}}
