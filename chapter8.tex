...
\begin{center}
\caption[SIGNAL REGION EVENT YIELDS BY LEPTON FLAVOR]{Expected (pre-fit) yields for signal and background processes, and observed yields in data}
...
%\end{center}
    \begin{tablenotes}
      \small
      \item NOTE: Uncertainties shown are purely statistical.
    \end{tablenotes}
 % \end{threeparttable}
\end{center}
\end{table}
...
\begin{figure}[htp]
\centering
%\includegraphics[width=0.49\textwidth]{ch8_figs/final_shape__ttH_stackPlot_SR.pdf}\\
\includegraphics[width=0.49\textwidth]{ch8_figs/final_shape_bdtv8__ttH_stackPlot_SR.pdf}\\
%\includegraphics[width=0.49\textwidth]{ch8_figs/tt_BDT_ttH_stackPlot_SR.pdf}
