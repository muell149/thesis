...
precise trajectories of the charged particles resulting from collisions.
...
As the particles travel through successive layers of silicon pixels, they leave a hits, or points of impact on each pixel.
The hits are measured with precision of 10 $\mu$m.
The particles trajectory or track is reconstructed from collections of hits. 
