...
\begin{figure}[hbtp]
 \begin{center}
   ...
   \caption{An overview of the LHC accelerator complex.}
...
\begin{figure}[hbtp]
 \begin{center}
   \includegraphics[width=0.9\textwidth]{ch3_figs/cms_overview.pdf}
   \caption{A qualitative overview of the CMS detector.\label{fig:cms_overview}}
 \end{center}
\end{figure}
